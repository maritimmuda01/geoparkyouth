  ...
  <div id="app">
    <div class="main-wrapper container">
      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        <!-- <a href="<?php echo base_url(); ?>" class="navbar-brand sidebar-gone-hide"><?= $site_settings['title'] ?></a> -->
        ...
        <div class="nav-collapse">
          ...
          <ul class="navbar-nav">
            <li class="nav-item <?php if($this->uri->segment(1) == "user") echo "active"?>"><a href="<?php echo base_url(); ?>" class="nav-link">Home</a></li>
            <li class="nav-item <?php if($this->uri->segment(1) == "articles") echo "active"?>"><a href="<?php echo base_url(); ?>articles" class="nav-link">Articles</a></li>
            <li class="nav-item"><a href="#" class="nav-link">Opinion</a></li>
            <li class="nav-item"><a href="#" class="nav-link">E-Library</a></li>
            <li class="nav-item <?php if($this->uri->segment(1) == "jobs") echo "active"?>"><a href="<?php echo base_url(); ?>jobs" class="nav-link">Jobs</a></li>
          </ul>
        </div>
