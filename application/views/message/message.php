...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/dashboard/css/message/messagestyle.css">
	<link href="https://fonts.googleapis.com/icon?family=Material+Icons"rel="stylesheet">
	<script src="https://cdn.jsdelivr.net/npm/pace-js@latest/pace.min.js"></script>
    <link rel="stylesheet" href="<?= base_url() ?>assets/dashboard/css/message/loading-bar.css">
...
<body>
	<section id="main" class="bg-dark">
		<div id="chat_user_list">
			<div id="owner_profile_details">
				<div id="owner_avtar" style="background-image: url('./assets/dashboard/img/profile/<?php echo $image;?>'); background-size: 100% 100%">
					<div>
						<div id="online"></div>
					</div>
				</div>
				...
				<div id="messageBar" class="py-4 px-4">
					<div id="textBox_attachment_emoji_container">
						<div id="text_box_message">
							<input type="text" maxlength = "300" name="txt_message" id="messageText" class="form-control" placeholder="Type your message">
						</div>
						<div id="text_counter">
	...
	<script type="text/javascript" src="<?= base_url() ?>assets/dashboard/js/message/main.js"></script>
</body>
</html>