...
?>
		<div class='innerBox'>
			<div class='user px-3 py-2'>
				<div id='avtar_and_details' class=''>
					<div id='user_avtar' style="background-image: url('<?= base_url() ?>/images/profile/<?php echo $data[$i]['profile_picture']; ?>'); background-size: 100% 100%;">
						<div id='online'></div>
						<input type='hidden' name='hdn' id='hidden_id' value="<?php echo $data[$i]['id']; ?>">
					</div>
					<div id='user_details' class='px-2'>
						<h6 id='name'><?php echo $data[$i]['name'] ?></h6>
	...
	?>
		<div class='innerBox'>
			<div class='user px-3 py-2'>
				<div id='avtar_and_details' class=''>
					<div id='user_avtar' style="background-image: url('<?= base_url() ?>assets//img/profile/<?php echo $data[$i]['profile_picture']; ?>'); background-size: 100% 100%;">
						<input type='hidden' name='hdn' id='hidden_id' value="<?php echo $data[$i]['id']; ?>">
					</div>
					<div id='user_details' class='px-2'>
