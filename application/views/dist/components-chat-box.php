                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <ul class="list-unstyled list-unstyled-border">
                      ...
                      <li class="media">
                        <img alt="image" class="mr-3 rounded-circle" width="50" src="<?php echo base_url(); ?>assets/dashboard/img/avatar/avatar-2.png">
                        <div class="media-body">
                      ...
                      <li class="media">
                        <img alt="image" class="mr-3 rounded-circle" width="50" src="<?php echo base_url(); ?>assets/dashboard/img/avatar/avatar-3.png">
                        <div class="media-body">
