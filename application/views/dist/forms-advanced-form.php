                        ...
                        <div class="col-6 col-sm-4">
                          <label class="imagecheck mb-4">
                            ...
                            <figure class="imagecheck-figure">
                              <img src="<?php echo base_url(); ?>assets/dashboard/img/news/img01.jpg" alt="}" class="imagecheck-image">
                            </figure>
                          </label>
                        </div>
                        <div class="col-6 col-sm-4">
                          <label class="imagecheck mb-4">
                            ...
                            <figure class="imagecheck-figure">
                              <img src="<?php echo base_url(); ?>assets/dashboard/img/news/img02.jpg" alt="}" class="imagecheck-image">
                            </figure>
                          </label>
                        </div>
                        <div class="col-6 col-sm-4">
                          <label class="imagecheck mb-4">
                            ...
                            <figure class="imagecheck-figure">
                              <img src="<?php echo base_url(); ?>assets/dashboard/img/news/img03.jpg" alt="}" class="imagecheck-image">
                            </figure>
                          </label>
                        </div>
                        <div class="col-6 col-sm-4">
                          <label class="imagecheck mb-4">
                            ...
                            <figure class="imagecheck-figure">
                              <img src="<?php echo base_url(); ?>assets/dashboard/img/news/img04.jpg" alt="}" class="imagecheck-image">
                            </figure>
                          </label>
                        </div>
                        <div class="col-6 col-sm-4">
                          <label class="imagecheck mb-4">
                            ...
                            <figure class="imagecheck-figure">
                              <img src="<?php echo base_url(); ?>assets/dashboard/img/news/img05.jpg" alt="}" class="imagecheck-image">
                            </figure>
                          </label>
                        </div>
                        <div class="col-6 col-sm-4">
                          <label class="imagecheck mb-4">
                            ...
                            <figure class="imagecheck-figure">
                              <img src="<?php echo base_url(); ?>assets/dashboard/img/news/img06.jpg" alt="}" class="imagecheck-image">
                            </figure>
                          </label>
                        </div>
                      </div>
