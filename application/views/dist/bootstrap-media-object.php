            ...
            <div class="row">
              <div class="col-12 col-md-6 col-lg-6">
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="media">
                      <img class="mr-3" src="<?php echo base_url(); ?>assets/dashboard/img/example-image-50.jpg" alt="Generic placeholder image">
                    ...
                    <div class="media">
                      ...
                      <div class="media-body">
                        ...
                        <div class="media mt-3">
                          <a class="pr-3" href="#">
                            <img src="<?php echo base_url(); ?>assets/dashboard/img/example-image-50.jpg" alt="Generic placeholder image">
                          </a>
                          <div class="media-body">
                            <h5 class="mt-0">Media heading</h5>
                            <p class="mb-0">Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi vulputate fringilla. Donec lacinia congue felis in faucibus.</p>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="media">
                      ...
                      <img class="ml-3" src="<?php echo base_url(); ?>assets/dashboard/img/example-image-50.jpg" alt="Generic placeholder image">
                    </div>
                  </div>
                </div>
              </div>
